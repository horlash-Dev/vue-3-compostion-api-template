...
const loadCWidget = ref(false);
const loadC_Widget = ref(false);
onMounted(() => {
  loadCWidget.value = true;
  loadC_Widget.value = true;

  setTimeout(() => {
    loadCWidget.value = false;
  }, 8000);
});
</script>
<template>
  <div>
    <transition
      name="custom-classes"
      mode="in-out"
      enter-to-class="animate__animated animate__fadeInTopRight"
      leave-to-class="animate__animated animate__rotateOutDownLeft"
      duration="700"
    >
      <div class="row" v-show="loadCWidget">
    ...
    <transition
      ...
      duration="700"
    >
      <div class="row" v-show="loadC_Widget">
        <div class="col-lg-6">
